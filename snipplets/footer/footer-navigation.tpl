...
{% set show_footer_navigation_title = show_footer_navigation_title is defined ? show_footer_navigation_title : true %}
{% set footer_mobile_toggle_title = show_footer_navigation_title and settings.footer_menus_toggle and footer_menu_title %}
...
<div class="{{ footer_nav_classes }} mb-md-0">
	...
	{% endif %}
		{% if show_footer_navigation_title and (footer_menu_title or theme_editor) %}
